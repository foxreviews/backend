...
MIGRATION_MODULES = {"sites": "foxreviews.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "foxreviews.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""ylan""", "ylan@fox-reviews.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "foxreviews.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "foxreviews.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "foxreviews.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "foxreviews.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
# FOX-Reviews AI Service Configuration
# ------------------------------------------------------------------------------
