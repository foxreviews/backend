"""
Service d'intégration avec l'API IA FOX-Reviews.
Appelle l'API externe pour génération d'avis décryptés.
"""
import logging
import requests
...
from foxreviews.core.models import AvisDecrypte, ProLocalisation
...
class AIService:
    """
    Service d'intégration avec l'API IA externe.
    Utilise l'endpoint /api/v1/agent en mode 'redaction'.
    """
    ...
    def _get_headers(self) -> Dict[str, str]:
        """Headers pour authentification API IA."""
        return {
